 ...
 * */
    ...
    /*@Query("CALL apoc.export.json.query(\"MATCH (a:City {name:'Kyiv'}), " +
            "(b:City {name:'Kharkiv'})MATCH p=(a)-[*]->(b) WITH collect(p) as paths\n" +
            "CALL apoc.spatial.sortByDistance(paths) YIELD path, distance\n" +
            "RETURN path, distance LIMIT 5\",\n" +
            "“routes.json”, null)\n" +
 ...
 * */
    ...
    //Collection<NewHubRequest> getAllLocations();
